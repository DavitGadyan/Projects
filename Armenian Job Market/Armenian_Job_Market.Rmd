...
Let's create new data frame which will sort out the most demanded inductries in Armenia by the number pf online job postings and make vicualizations using this dataset to make communicate meaningfull messages.
